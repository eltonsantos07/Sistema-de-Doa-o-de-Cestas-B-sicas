...
public class Estoque {
	...
	public ArrayList<Estoque> inicializarEstoqueAlimentos(ArrayList<Estoque> estoqueGeral) {
	...
	public ArrayList<Estoque> inicializarEstoqueCobertores(ArrayList<Estoque> estoqueGeral) {
	...
	public ArrayList<Estoque> inicializarEstoqueLimpeza(ArrayList<Estoque> estoqueGeral) {
